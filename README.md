...
SUB_TOKEN：设置生成订阅的安全秘钥（例如 MySecretToken888），用户前端生成时必须填写。特别注意:⚠️⚠️⚠️用户前端生成时的安全Token就是这个SUB_TOKEN值 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
🚀 使用说明
...
## ⭐  ⭐  ⭐ Star 星星走起
## Star History 
<a href="https://www.star-history.com/?repos=xiagefei%2FGeFei-Sub-Worker-&type=timeline&logscale=&legend=bottom-right">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=xiagefei/GeFei-Sub-Worker-&type=timeline&theme=dark&logscale&legend=bottom-right" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=xiagefei/GeFei-Sub-Worker-&type=timeline&logscale&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=xiagefei/GeFei-Sub-Worker-&type=timeline&logscale&legend=bottom-right" />
 </picture>
</a>
